<div class="dropdown mb-5" >
        <button class="btn mb-5 dropdown-toggle text-white justify-content-start align-items-start" data-bs-toggle="dropdown">
         <i class="fa fa-ellipsis-v mb-5 text-start text-white fs-4"></i>
        </button>
        <ul class="dropdown-menu mb-4">
            <li class="ms-3 mb-1"><button id="back" style="background-color:rgb(33, 33, 63); color:white;" class="btn mt-4"><i class="bi bi-arrow-left me-1"></i> Back</button></li>
