...
<head>
    <meta charset="utf-8" />
    <title>Edit Your Note - WikkiNote</title>
...
<body>
    ...
    ?>
        ...
        <div id="container">
            ...
            <p id="h1"><img class="imgs" src="../../../../assets/wikki.svg"><u>WikkiNote</u> - Edit your <?php echo $row['subjects']; ?> Note:</p>

            <form action="" method="post">
                <fieldset>
                    <label for="subject">Subject:</label>
                    <input type="text" id="subject" value="<?php echo $row['subjects']; ?>" name="subject" />

                    <label for="topic">Topic:</label>
                    <input type="text" id="topic" value="<?php echo $row['topic']; ?>" name="topic" />

                    <label for="note" style="margin-bottom: -15px;">Note/Summary:</label>
                    <textarea id="note" name="note"><?php echo $row['content']; ?></textarea>
        ...
        if (isset($_POST['save'])) {
            ...
            $sql = "UPDATE wikkinote SET subjects='$subject',topic='$topic',content='$content' WHERE noteid=$noteid AND user_email='$mymail';";
            $result = mysqli_query($con, $sql);
            if (!$result) { ?>
                <script>
